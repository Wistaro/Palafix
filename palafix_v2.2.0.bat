rem Palafix v2.2.0
rem
rem release date: June, 6th 2019
rem
rem
rem **************************************************************
rem Made by Wistaro {##Discord: Wistaro#9308, ##Twitter: @Wistaro}
...
set last_version=211
set jre64BundleId=238729_478a62b7d4e34b78b671c754eaaf38ab
set jre32BundleId=238727_478a62b7d4e34b78b671c754eaaf38ab
set pourcentVal=1
...
:MENU
cls
title Palafix v2.2.0 - By Wistaro
color 06
...
if exist "getUser.bat" (
	...
	powershell -Command "(New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Wistaro/Palafix/master/getUser.bat', 'getUser.bat')"
	echo Telechargement termine!
...
echo 		powershell -Command "(New-Object Net.WebClient).DownloadFile('http://ressources.paladium-pvp.fr/Paladium.exe', 'Paladium.exe')" >> "%userprofile%\Desktop\StartPaladium.bat"
...
powershell -Command "(New-Object Net.WebClient).DownloadFile('http://ressources.paladium-pvp.fr/Paladium.exe', 'Paladium.exe')"
